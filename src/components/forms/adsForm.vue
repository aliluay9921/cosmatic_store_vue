...
export default {
  ...
  computed: {
    ...
    selected_object() {
      return this.$store.state.Ads.selected_object;
    },
    isEdit() {
      return this.$store.state.Ads.isEdit;
    },
  },
  methods: {
    ...
    addAds(data) {
      this.$store.dispatch("Ads/addAds", data);
      this.reset();
    },
    editAds(data) {
      console.log(data);
      this.$store.dispatch("Ads/editAds", data);
      this.reset();
    },
    reset() {
  ...
  watch: {
    isEdit() {
      ...
      this.$store.state.Ads.isEdit = false;
      this.isUpdate = true;
    },
  },
};
