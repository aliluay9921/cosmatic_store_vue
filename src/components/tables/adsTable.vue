...
export default {
  ...
  computed: {
    ...
    adsQuery: {
      set(val) {
        this.$store.state.Ads.adsQuery = val;
      },
      get() {
        return this.$store.state.Ads.adsQuery;
      },
    },
    ads_products() {
      return this.$store.state.Ads.ads_products;
    },
    pageCount: function () {
      return this.$store.state.Ads.pageCount;
    },
    totalItems: function () {
      return this.$store.state.Ads.adverstments.length;
    },

    adverstments() {
      return this.$store.state.Ads.adverstments;
    },
    table_loading() {
      return this.$store.state.Ads.table_loading;
    },
    ads_params: {
      set(val) {
        this.$store.state.Ads.params = val;
      },
      get() {
        return this.$store.state.Ads.params;
      },
    },
  },
  methods: {
    selectedRaw(item) {
      console.log(item);
      this.$store.state.Ads.selected_object = {};

      Object.assign(this.$store.state.Ads.selected_object, item);
      this.$store.state.Ads.isEdit = true;
      window.scrollTo({
        top: 0,
        left: 0,
        behavior: "smooth",
    ...
    getProducts(id) {
      this.$store.dispatch("Ads/getProductsAds", id);
      this.dialog2 = true;
      // this.$store.dispatch("Ads/resetFields");
    },
    getItem(item) {
      this.dialog = true;
      this.item = item;
    ...
    deleteAds() {
      ...
      this.$store.dispatch("Ads/deleteAds", this.item);
      this.dialog = false;
      this.item = {};
    },
    getAds() {
